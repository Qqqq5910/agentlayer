# anonymized-005 Real-World Scan Summary
...
- Sample ID: anonymized-005
- Public root URL scanned: redacted in committed sample
- Site type: Network, security, and developer platform
- Scan status: failed_or_blocked_before_scan_json
- Pages scanned: 0
...
- Initial public-root scan did not finish before the bounded outer timeout; no task or score data
  was collected.
