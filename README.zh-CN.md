...
当前源码版本是 `0.2.0-alpha.2`。这是用于公开网站试用和本地 baseline/compare 工作流的 alpha 版本。
...
AgentLayer 需要更多真实公开网站的扫描结果来改进默认启发式规则。如果你愿意分享结果，可以在
[置顶扫描反馈 issue](https://github.com/Qqqq5910/agentlayer/issues/1) 留言，或按
