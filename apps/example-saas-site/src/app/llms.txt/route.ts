...
> Customer workflow automation for B2B SaaS teams.
...
- [Security](http://localhost:3001/security): Security, trust, access control, and review packet information.
- [Integrations](http://localhost:3001/integrations): CRM, chat, automation, and warehouse integrations.
...
## Notes For AI Agents
- Do not submit forms without explicit user confirmation.
- Treat AcmeFlow as a fictional demo site for AgentLayer.
- Verify factual claims against source pages.
`;
