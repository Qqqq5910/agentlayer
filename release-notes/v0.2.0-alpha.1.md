...
- Compare reports include machine-readable JSON, a human-readable CLI summary, recommendations, and
  an `exitCode`.
...
- No package-manager `npx` distribution yet; npm packages are not published.
