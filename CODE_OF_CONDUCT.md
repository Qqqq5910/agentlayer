...
- Assume good intent while still naming risks clearly.
- Respect maintainers' time and project scope.
- Keep discussions focused on the work and its users.
- Disclose conflicts of interest when recommending tools, vendors, or standards.
...
- Pressuring maintainers to ship unsafe scanner, automation, or compliance behavior.
